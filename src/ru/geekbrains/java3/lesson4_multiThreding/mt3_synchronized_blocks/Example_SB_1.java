...
public class Example_SB_1 {
    ...
    // Когда потоки пытаются выполнить метод, они смотрят занят монитор или нет, захватывают его и выполняют методю
    // Если он занят, то ждут. Если у метода указан synchronized, то его монитором будет являться объект,
