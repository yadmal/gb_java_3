...
public class Example_SB_4_Chairs {
    public static void main(String[] args) throws Exception {
        Object стул1 = new Object();
        Object стул2 = new Object();

        // первые 3 человека в качестве монитора используют один объект для своих блоков синхронизации,
        // а значит эти блоки будут выполняться по мере освобождения монитора.
        // Для четвертого человека выделен отдельный объект и он не ждет
